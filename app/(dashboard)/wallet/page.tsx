        ...
        <CardContent className="p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-4xl font-black">{formatMinorAmount(balance, currency)}</p>
              </div>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <Button variant="outline" className="border-white/30 text-white hover:bg-white/10" disabled>
              <ArrowDownToLine size={18} /> Withdraw (soon)
            </Button>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between py-3 border-b border-gray-100">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-100 text-authepay-green text-sm font-medium">
              <span className="w-1.5 h-1.5 rounded-full bg-authepay-green" /> {wallet?.status ?? "unknown"}
            </span>
          </div>
        </CardContent>
      </Card>
